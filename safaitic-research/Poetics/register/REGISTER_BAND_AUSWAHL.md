...
- **Vor- & Nachwort:** neues **Vorwort** im Frontmatter; **Nachwort** im Backmatter mit drei Abschnitten — *Das OCIANA-Korpus*, *Die editorischen Siglen* und *Die Fundorte* (nach Zonen). Beide Listen decken sich **exakt** mit dem Text: jedes im Band vorkommende Sigle-Präfix (34) und jeder Fundort (37) ist erklärt, und es steht nichts darin, das nicht auch im Band vorkommt (per Skript geprüft). Das Nachwort liegt zusätzlich separat als `nachwort.docx`. Der frühere Backmatter (Auto-Einleitung, „Zu den Kapiteltiteln“, die alten Tabellen) ist durch diese kuratierte Fassung ersetzt.
