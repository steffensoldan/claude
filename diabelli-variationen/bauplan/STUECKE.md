# Die dreiunddreißig Stücke — Kurzbriefings
...
| VIII | Glättung | Der Satz so lange begradigt, bis nichts mehr hakt — und nichts mehr da ist. | Vorschlag |
| IX | **Verdunkelung** | Erstes Auftreten des Ich. Derselbe Satz, aus dem alles Helle entfernt ist. Kein neues Wort, nur Auslassung. | belegt |
| X | Abriss | Beschleunigung bis zur Unlesbarkeit, dann Ende mitten im Wort. | Vorschlag |
| XI | Zerlegung | Der Satz in Silben aufgelöst, die Silben in ihrer Reihenfolge belassen. | Vorschlag |
| XII | Umkehrung | Der Satz von hinten. Die Kadenz steht am Anfang, die Wiederholung am Schluss. | Vorschlag |
| XIII | **Auslassung** | Das einzige Stück ohne den Kernsatz. Nur seine Zäsuren stehen auf der Seite. Kürzestes Stück des Bandes. Grad D denkbar. | belegt |
| XIV | **Dehnung** | Der Satz über mehrere Seiten, ein Wort je Zeile, mit wachsenden Abständen. Längstes Stück der ersten Hälfte. | belegt |
| XV | Verkleinerung | Der ganze Satz, aber in seinen kleinsten möglichen Wörtern. Nichts fehlt, alles ist geschrumpft. | Vorschlag |
...
| XXX | **Klage** | Der Satz ohne Widerstand. Nichts wird ihm angetan; er trägt sich selbst nicht mehr. | belegt |
| XXXI | **Rückdatierung** | Der Satz in einer älteren Sprache, überreich verziert, jede Wendung ausgeschmückt. Drittes langes Stück, Höhepunkt der dunklen Gruppe. | belegt |
| XXXII | **Vervielfachung und Abbruch** | Höchste Dichte des Bandes: der Satz gegen sich selbst in mehreren Schichten — und dann Ende mitten im Satz, unaufgelöst. Kein Schluss, ein Übergang. | belegt |
| XXXIII | **Rückzug** | Der Satz zum ersten und einzigen Mal ganz einfach gesagt, in einer älteren, milderen Form, leiser werdend. Kein Triumph, kein Fazit. Das Ich spricht, kurz. | belegt |

## Belegte Grundlagen der elf Pfeiler

| Nr. | Gesicherte Charakteristik der Variation |
|---|---|
| I | *Alla marcia maestoso*, 4/4 — Marsch gegen den 3/4-Walzer des Themas |
| IX | c-Moll |
| XIII | Markante Pausen und Abbrüche |
| XIV | *Grave e maestoso* — starke Verlangsamung |
| XX | *Andante*, harmonisch rätselhaft, nahezu unbewegt |
| XXII | *Allegro molto*, Zitat „Notte e giorno faticar" aus Mozarts *Don Giovanni* |
| XXIV | *Fughetta*, *Andante* |
| XXIX–XXXI | c-Moll-Gruppe |
| XXXI | *Largo, molto espressivo*, verziertes Adagio in Bach-Nähe |
| XXXII | *Fuga*, Es-Dur, endet abbrechend, dann Überleitung |
| XXXIII | *Tempo di Menuetto moderato* |
